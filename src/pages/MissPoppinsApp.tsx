    ...
    <main>
      ...
      <section className="mp-container">
        ...
        <div className="mp-image-section">
          <video
            className="mp-video"
            src="/assets/misspoppinsapp/misspoppinsappvideo1.mov"
            autoPlay
            muted
            loop
            playsInline
      ...
      <section className="mp-background-section">
        ...
        <div className="mp-background-icons">
          <div className="mp-background-icon">
            <img
              src="/assets/misspoppinsapp/consultation.svg"
              alt="Consultation"
            />
          ...
          <div className="mp-background-icon">
            <img
              src="/assets/misspoppinsapp/videochat.svg"
              alt="Video Support"
            />
            <p className="mp-background-small-text">
          ...
          <div className="mp-background-icon">
            <img
              src="/assets/misspoppinsapp/webinars.svg"
      ...
      <section className="mp-research-section">
        ...
        <div className="mp-research-steps">
          <div className="mp-step">
            ...
            <img src="/assets/misspoppinsapp/step1.svg" alt="Step 1" />
          </div>
          <div className="mp-step">
            ...
            <img src="/assets/misspoppinsapp/step2.svg" alt="Step 2" />
          </div>
          <div className="mp-step">
            ...
            <img src="/assets/misspoppinsapp/step3.svg" alt="Step 3" />
          </div>
        </div>
        ...
        <div className="mp-subcategories">
          <div className="mp-subcategory">
            <img
              src="/assets/misspoppinsapp/info-sources.svg"
          ...
          <div className="mp-subcategory">
            <img
              src="/assets/misspoppinsapp/architecture.svg"
          ...
          <div className="mp-subcategory">
            <img
              src="/assets/misspoppinsapp/package.svg"
              alt="Package Pricing"
            />
          ...
          <div className="mp-subcategory">
            <img
              src="/assets/misspoppinsapp/community.svg"
          ...
          <div className="mp-subcategory">
            <img
              src="/assets/misspoppinsapp/accessibility.svg"
              alt="Resource Access"
            />
            <p className="mp-small-text-research">
      ...
      <section className="mp-analysis-section">
        ...
        <div className="mp-image-wrapper">
          <img
            src="/assets/misspoppinsapp/image2.png"
      ...
      <section className="mp-key-findings-section">
        ...
        <div className="mp-finding">
          <img
            src="/assets/misspoppinsapp/strength.svg"
            alt="Strengths Icon"
          />
        ...
        <div className="mp-finding">
          <img
            src="/assets/misspoppinsapp/opportunity.svg"
        ...
        <div className="mp-finding">
          <img
            src="/assets/misspoppinsapp/keydiff.svg"
      ...
      <section className="mp-user-interviews-section">
        ...
        <div className="mp-user-interview-content">
          <div className="mp-user-interview-info">
            <img
              src="/assets/misspoppinsapp/number7.svg"
              alt="7 Interviews"
            />
            <p className="mp-main-text">user interviews conducted</p>
          </div>
          <img
            src="/assets/misspoppinsapp/userinterview.svg"
      ...
      <section className="mp-findings-section">
        ...
        <div className="mp-finding-header">
          <img
            src="/assets/misspoppinsapp/researchfindingsicon1.svg"
            alt="Finding Icon"
      ...
      <section className="mp-researchfinding-section">
        <div className="mp-finding-header">
          <img
            src="/assets/misspoppinsapp/researchfindings2icon.svg"
            alt=""
            className="mp-finding-icon"
          />
        ...
        <div className="mp-row">
          <img
            src="/assets/misspoppinsapp/researchfindings2.svg"
            alt=""
            className="mp-finding-postit"
          />
          <img
            src="/assets/misspoppinsapp/researchfindings2-1.svg"
            alt=""
            className="mp-finding-postit"
          />
          <img
            src="/assets/misspoppinsapp/researchfindings2-2.svg"
            alt=""
            className="mp-finding-postit"
          />
        </div>
        ...
        <div className="mp-row mp-bottom-row">
          <img
            src="/assets/misspoppinsapp/researchfindings2-3.svg"
            alt=""
            className="mp-finding-postit"
          />
          <img
            src="/assets/misspoppinsapp/researchfindings2-4.svg"
            alt=""
            className="mp-finding-postit"
          />
        </div>
      ...
      <section className="mp-researchfinding-section">
        <div className="mp-finding-header">
          <img
            src="/assets/misspoppinsapp/researchfindings3icon.svg"
            alt=""
        ...
        <div className="mp-row">
          <img
            src="/assets/misspoppinsapp/researchfindings3.svg"
            alt=""
            className="mp-finding-postit"
          />
          <img
            src="/assets/misspoppinsapp/researchfindings3-1.svg"
            alt=""
            className="mp-finding-postit"
          />
        </div>
        ...
        <div className="mp-row mp-bottom-row">
          <img
            src="/assets/misspoppinsapp/researchfindings3-2.svg"
            alt=""
            className="mp-finding-postit"
          />
          <img
            src="/assets/misspoppinsapp/researchfindings3-3.svg"
            alt=""
            className="mp-finding-postit"
          />
        </div>
        ...
        <div className="mp-hmw-steps">
          <div className="mp-hmw-step">
            <div className="mp-hmw-icontext">
              <img
                src="/assets/misspoppinsapp/calendaricon.svg"
                alt="Calendar Icon"
          ...
          <div className="mp-hmw-step">
            <div className="mp-hmw-icontext">
              <img
                src="/assets/misspoppinsapp/timeicon.svg"
                alt="Timer Icon"
                className="mp-hmw-icon"
              />
              <div>
        ...
        <div className="mp-hmw-before-after-row">
          <div className="mp-hmw-combo">
            ...
            <div className="mp-hmw-pair">
              <img
                src="/assets/misspoppinsapp/hmwbefore1.svg"
          ...
          <div className="mp-hmw-combo">
            ...
            <div className="mp-hmw-pair">
              <img
                src="/assets/misspoppinsapp/hmwafter1.svg"
      ...
      <section className="mp-hmw-answer-section">
        ...
        <div className="mp-hmw-steps">
          <div className="mp-hmw-step">
            <div className="mp-hmw-icontext">
              <img
                src="/assets/misspoppinsapp/selectchoices.svg"
                alt="Select Icon"
                className="mp-hmw-icon"
              />
              <div>
          ...
          <div className="mp-hmw-step">
            <div className="mp-hmw-icontext">
              <img
                src="/assets/misspoppinsapp/goldstar.svg"
                alt="Gold Star"
        ...
        <div className="mp-hmw-before-after-row">
          <div className="mp-hmw-combo">
            ...
            <div className="mp-hmw-pair">
              <img
                src="/assets/misspoppinsapp/hmwbefore2.svg"
                alt="Before Packages"
                className="mp-hmw-phone"
              />
              <p className="mp-hmw-text">
          ...
          <div className="mp-hmw-combo">
            ...
            <div className="mp-hmw-pair">
              <img
                src="/assets/misspoppinsapp/hmwafter2.svg"
                alt="After Packages"
                className="mp-hmw-phone"
              />
              <p className="mp-hmw-text">
      ...
      <section className="hmw3-section">
        ...
        <div className="hmw3-step">
          <img
            src="/assets/misspoppinsapp/hmwsearchicon.svg"
            alt="Search Icon"
            className="hmw3-icon"
          />
        ...
        <div className="mp-hmw-before-after-row3">
          <div className="mp-hmw-combo3">
            ...
            <div className="mp-hmw-pair3">
              <img
                src="/assets/misspoppinsapp/hmwbefore3.svg"
                alt="Before"
                className="mp-hmw-phone"
              />
              <p className="mp-hmw-text">
          ...
          <div className="mp-hmw-combo3">
            ...
            <div className="mp-hmw-pair3">
              <img
                src="/assets/misspoppinsapp/hmwafter3.svg"
                alt="After"
                className="mp-hmw-phone"
              />
              <p className="mp-hmw-text">
        ...
        <div className="hmw3-subsection">
          <div className="hmw3-step">
            <img
              src="/assets/misspoppinsapp/hmwslidebar.svg"
              alt="Slidebar Icon"
              className="hmw3-icon"
            />
            <div className="hmw3-step-text">
          ...
          <div className="hmw3-row-slider">
            <div className="hmw3-column">
              ...
              <div className="hmw3-img-description">
                <video
                  ...
                  src="/assets/misspoppinsapp/hmw3-2.mov"
                  autoPlay
                  muted
                  loop
                  playsInline
            ...
            <div className="hmw3-column">
              ...
              <div className="hmw3-img-description">
                <video
                  className="mp-video3-2"
                  src="/assets/misspoppinsapp/hmw3-2-2.mov"
                  autoPlay
                  muted
                  loop
                  playsInline
      ...
      <section className="hmw4-section">
        ...
        <div className="hmw4-phone-row">
          <img
            src="/assets/misspoppinsapp/hmw4before.svg"
            className="hmw4-phone"
            alt="Before Chat & Mentor"
          />
          <img
            src="/assets/misspoppinsapp/hmw4after.svg"
            className="hmw4-phone"
      ...
      <section className="mp-wireframes-section">
        ...
        <div className="mp-wireframes-row">
          <img
            src="/assets/misspoppinsapp/wireframe1.svg"
            alt="Wireframe 1"
            className="mp-wireframe-img"
          />
          <img
            src="/assets/misspoppinsapp/wireframe2.svg"
            alt="Wireframe 2"
            className="mp-wireframe-img"
          />
          <img
            src="/assets/misspoppinsapp/wireframe3.svg"
            alt="Wireframe 3"
            className="mp-wireframe-img"
          />
        </div>
